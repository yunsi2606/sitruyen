...
export interface ApiChapterChapter extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    chap_published_at: Schema.Attribute.Date;
    chapter_number: Schema.Attribute.Decimal;
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    reading_histories: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiFollowFollow extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    follow_at: Schema.Attribute.DateTime;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::follow.follow'
...
export interface ApiReadingHistoryReadingHistory
  extends Struct.CollectionTypeSchema {
  collectionName: 'reading-histories';
  info: {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    history_updated_at: Schema.Attribute.DateTime;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::reading-history.reading-history'
...
export interface ApiStoryStory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    story_published_at: Schema.Attribute.Date;
    story_status: Schema.Attribute.Enumeration<
      ['ongoing', 'completed', 'dropped']
    >;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    total_chapters: Schema.Attribute.Integer;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    view_count: Schema.Attribute.BigInteger;
