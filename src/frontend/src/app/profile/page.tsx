    ...
    const handleClaimDaily = async () => {
        ...
        try {
            ...
            if (res) {
                ...
                alert(res.alreadyClaimed ? t("alreadyClaimed") : t("claimed", { exp: res.expGained }));
            }
        } catch (err) {
    ...
    return (
        <div className="container max-w-[1280px] mx-auto px-6 py-12 animate-in fade-in-up duration-500">
                        ...
                        {levelData && (
                            <div className="w-full max-w-md mt-4 space-y-1.5 bg-black/40 p-3 rounded-xl border border-white/5 backdrop-blur-md">
                                <div className="flex items-center justify-between text-xs font-bold uppercase tracking-wider">
                                    <span className="text-accent">{t("level")} {levelData.level}</span>
                                    <span className="text-muted">{t("expLabel", { current: levelData.exp, total: levelData.nextLevelExp || t("maxExp") })}</span>
                                </div>
                                ...
                                <div className="flex justify-between items-center pt-1">
                                    ...
                                    >
                                        ...
                                        {levelData.dailyClaimed ? t("dailyClaimed") : t("claimDaily")}
                                    </button>
                                </div>
                            </div>
                        )}
            ...
            <div className="flex items-center gap-6 border-b border-white/5 mb-8">
                ...
                >
                    <History className="w-4 h-4" /> {t("readingHistory")}
                </button>
                <button
                ...
                >
                    <Palette className="w-4 h-4" /> {t("cosmeticsAndRewards")}
                </button>
            </div>
                ...
                <div className="lg:col-span-4 space-y-6 h-fit sticky top-24">
                    <div className="bg-surface border border-white/5 rounded-2xl p-6 space-y-6">
                        <h3 className="text-lg font-bold text-white flex items-center gap-2">
                            <User className="w-5 h-5 text-accent" /> {t("accountInfo")}
                        </h3>

                        <div className="space-y-4">
                            <div className="flex items-center justify-between py-3 border-b border-white/5">
                                <span className="text-sm text-muted">{t("joinDate")}</span>
                            ...
                            <div className="flex items-center justify-between py-3 border-b border-white/5">
                                <span className="text-sm text-muted">{t("expMultiplier")}</span>
                        ...
                        <div className="space-y-4 animate-in fade-in slide-in-from-right-4 duration-500">
                            ...
                            {recentHistory.length > 0 ? (
                                ...
                                <div className="bg-surface border border-white/5 rounded-2xl p-12 text-center space-y-4">
                                    ...
                                    <p className="text-muted">{t("noReadingHistory")}</p>
                                </div>
                            )}
                        </div>
                    )}
                        ...
                        <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-500">
                            ...
                            <div className="bg-surface border border-white/5 rounded-2xl p-6">
                                <h3 className="text-lg font-bold text-white mb-6 flex items-center gap-2">
                                    <User className="w-5 h-5 text-accent" /> {t("avatarFrames")}
                                </h3>
                            ...
                            <div className="bg-surface border border-white/5 rounded-2xl p-6">
                                <h3 className="text-lg font-bold text-white mb-6 flex items-center gap-2">
                                    <Palette className="w-5 h-5 text-accent" /> {t("nameColors")}
                                </h3>
